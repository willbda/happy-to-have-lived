...
- **View-Debug**: 4 files (avg 223 lines)
...
- **Service-Embedding**: 2 files (avg 357 lines)
- **Model-Deduplication**: 2 files (avg 143 lines)
- **ViewModel-LLM**: 1 files (avg 191 lines)
...
- **HIGH**: missing_baserepository (2 files)
